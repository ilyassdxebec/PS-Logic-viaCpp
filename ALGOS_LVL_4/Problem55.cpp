...
stDate CalculateVacationReturnDate(stDate DateFrom, int VacationDays)
{
...
{   
    ...
    cout<<"\n\nReturn Date is : "<<DayShortName(DayOfWeekOrder(DateTo))<<" , "<<DateTo.Day<<"/"<<DateTo.Month<<"/"<<DateTo.Year;
}